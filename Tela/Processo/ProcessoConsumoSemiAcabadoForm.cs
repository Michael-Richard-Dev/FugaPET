...
public partial class ProcessoConsumoSemiAcabadoForm : Form
{
    ...
    private const string TituloConsumoSemiAcabado = "Consumo de Semi Acabado";
    private const string SubtituloConsumoSemiAcabado = "Pesagem e consumo de semi acabado da ordem de produção";
    private const string NomeModuloConsumoSemiAcabado = "Consumo de Semi Acabado";
    ...
    public ProcessoConsumoSemiAcabadoForm()
        : this(ModoConsumoMaterial.MateriaPrima)
    {
    }

    public ProcessoConsumoSemiAcabadoForm(ModoConsumoMaterial modo)
    ...
    /// </summary>
    public ProcessoConsumoSemiAcabadoForm(ModoConsumoMaterial modo, ContextoApontamentoProcesso contextoApontamento)
        : this(modo, ClassificadorOrdemConsumoMaterial.Padrao, contextoApontamento)
    {
    }

    public ProcessoConsumoSemiAcabadoForm(ContextoApontamentoProcesso contextoApontamento)
        : this(ModoConsumoMaterial.MateriaPrima, ClassificadorOrdemConsumoMaterial.Padrao, contextoApontamento)
    {
    }

    internal ProcessoConsumoSemiAcabadoForm(
    ...
    {
        Text = TituloConsumoSemiAcabado;
        headerTitleLabel.Text = TituloConsumoSemiAcabado;
        headerSubtitleLabel.Text = SubtituloConsumoSemiAcabado;
    }

    private string TituloMensagemConsumo => TituloConsumoSemiAcabado;

    private string NomeOperacionalConsumo => NomeModuloConsumoSemiAcabado;
    ...
    private async Task<bool> BloquearAcaoSemPermissaoAsync(string acao, string descricaoAcao)
    {
        ...
        await global::FugaPET_Dev.Tela.Comum.AcaoNegadaHelper.RegistrarAcaoNegadaSeguroAsync(
            AutorizacaoServico.ModuloProcesso, PermissoesSistema.Rotinas.LeituraProducao, acao, descricaoAcao, "ProcessoConsumoSemiAcabadoForm");
    ...
    internal static bool ClassificacaoPorModoBloqueiaComponente(
        ComponenteConsumoMaterial componente,
        ModoConsumoMaterial modo,
        bool possuiContextoApontamento)
        => !possuiContextoApontamento && !ComponentePertenceAoModo(componente, modo);
    ...
    private bool ComponentePodeOperar(ComponenteConsumoMaterial? componente, out string motivoBloqueio)
    {
        ...
        if (ClassificacaoPorModoBloqueiaComponente(
            componente,
            _modoConsumo,
            _contextoApontamento is not null))
        {
