...
-- FugaPET - Incremental 044 DEV - REV6
-- PREFLIGHT exclusivamente READ ONLY.
-- Compatibilidade operacional REV6: PostgreSQL major 15, versao minima 15.5.
...
-- Estado do próprio incremental 044 REV6.
SELECT
    'ESTADO_044_REV6' AS grupo,
...
BEGIN
    ...
    IF v_columns_044 = 59 AND v_objects_044 = 34 AND v_columns_rev5=2 AND v_objects_rev5=3 THEN
        ...
        RAISE NOTICE 'ESTADO_PACOTE=PACOTE_REV6_NOMES_PRESENTES_ASSINATURAS_DEVEM_SER_VALIDADAS_PELA_PROPOSTA';
        RETURN;
    END IF;
    ...
    RAISE NOTICE 'CLASSIFICACAO_OFICIAL=PREFLIGHT_044_APROVADO';
    RAISE NOTICE 'ESTADO_PACOTE=PACOTE_REV6_NAO_APLICADO';
